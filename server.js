...
app.get("/list", (request, response) => {
  var sqlQuery = `SELECT * FROM aditi_sharma`;
...
app.post("/create", (request, response) => {
  ...
  var sqlQuery = `INSERT INTO aditi_sharma (name, age, location, email, blood_group) VALUES ('${name}', ${age}, '${_location}', '${email}', '${blood_group}')`;
...
app.put("/edit/:id", (request, response) => {
  ...
  var sqlQuery = `UPDATE aditi_sharma SET name='${name}', age=${age}, location='${_location}', email='${email}', blood_group='${blood_group}' WHERE id=${id}`;
...
app.delete("/delete/:id", (request, response) => {
  ...
  var sqlQuery = `DELETE FROM aditi_sharma WHERE id=${id}`;
